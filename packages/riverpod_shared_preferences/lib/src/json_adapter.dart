...
final class Riverpod {
  const Riverpod({this.encodeArgs});

  // TODO to type
  final FutureOr<Object?> Function(Object? value, Persist persist)? encodeArgs;
}

abstract class OfflineNotifier<StateT, EncodedT> {
  Object? get offlineKey;
  FutureOr<StateT> decode(EncodedT value);
  FutureOr<EncodedT> encode(StateT value);
}
...
abstract class JsonAdapter<T> extends PersistAdapter {
  FutureOr<T> fromJson(Map<String, Object?> json);

  FutureOr<Map<String, Object?>> toJson(T value);
}
