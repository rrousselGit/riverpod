...
typedef OrphanCreate<CreatedT, RefT> = CreatedT Function<StateT>(RefT ref);
typedef OrphanNotifierCreate<RefT> = NotifierT Function<StateT>(RefT ref);

@internal
class FamilyBuilder<CallT, AutoDisposeT> {
  const FamilyBuilder({
    required this.call,
  ...
  /// ```
  /// {@endtemplate}
  final AutoDisposeT autoDispose;
}

@internal
class ProviderBuilder<CallT, FamilyT> {
