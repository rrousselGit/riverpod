...
final class GenericProvider<A, B> extends $FunctionalProvider<int, int, int>
    with $Provider<int> {
...
String _$genericHash() => r'c5305079a1a0a5e899bec2f537898afa92f85a6f';
...
final class GenericFamily extends $Family {
  ...
  Override overrideWith(int Function<A, B>(Ref ref) create) => $FamilyOverride(
    from: this,
