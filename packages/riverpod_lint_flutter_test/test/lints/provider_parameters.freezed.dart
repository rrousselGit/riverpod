...
/// Adds pattern-matching-related methods to [FreezedExample].
extension FreezedExamplePatterns on FreezedExample {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FreezedExample value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FreezedExample() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FreezedExample value)  $default,){
final _that = this;
switch (_that) {
case _FreezedExample():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FreezedExample value)?  $default,){
final _that = this;
switch (_that) {
case _FreezedExample() when $default != null:
return $default(_that);case _:
...
$ClassicFreezedCopyWith<ClassicFreezed> get copyWith => _$ClassicFreezedCopyWithImpl<ClassicFreezed>(this as ClassicFreezed, _$identity);
...
abstract mixin class $ClassicFreezedCopyWith<$Res>  {
  factory $ClassicFreezedCopyWith(ClassicFreezed value, $Res Function(ClassicFreezed) _then) = _$ClassicFreezedCopyWithImpl;
@useResult
$Res call({
 int value
});
...
/// Adds pattern-matching-related methods to [ClassicFreezed].
extension ClassicFreezedPatterns on ClassicFreezed {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
