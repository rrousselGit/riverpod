...
part of 'missing_dependencies.provider_dependencies-83.fix.dart';
...
final class PlainAnnotationProvider extends $FunctionalProvider<int, int, int>
  ...
  PlainAnnotationProvider._()
    : super(
        ...
        dependencies: <ProviderOrFamily>[depProvider],
        $allTransitiveDependencies: <ProviderOrFamily>[
          PlainAnnotationProvider.$allTransitiveDependencies0,
        ],
      );
...
String _$plainAnnotationHash() => r'64e9e9de32cf7f3de9ea3645b395e0931ade972c';
