...
part of 'missing_dependencies.provider_dependencies-110.fix.dart';
...
final class ExistingDepProvider extends $FunctionalProvider<int, int, int>
  ...
  ExistingDepProvider._()
    : super(
        ...
        dependencies: <ProviderOrFamily>[depProvider],
        $allTransitiveDependencies: <ProviderOrFamily>[
          ExistingDepProvider.$allTransitiveDependencies0,
        ],
      );
...
String _$existingDepHash() => r'6f127cd2c7cab63e792aea4064dc921de51c75af';
