...
part of 'missing_dependencies.provider_dependencies-90.fix.dart';
...
final class CustomAnnotationProvider extends $FunctionalProvider<int, int, int>
  ...
  CustomAnnotationProvider._()
    : super(
        ...
        dependencies: <ProviderOrFamily>[depProvider],
        $allTransitiveDependencies: <ProviderOrFamily>[
          CustomAnnotationProvider.$allTransitiveDependencies0,
        ],
      );
...
String _$customAnnotationHash() => r'f147fd1255e6f1767d9318df7808ec9b6200fda4';
