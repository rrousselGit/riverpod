...
part of 'unused_dependency.provider_dependencies-27.fix.dart';
...
final class ExtraDepProvider extends $FunctionalProvider<int, int, int>
  ...
  ExtraDepProvider._()
    : super(
        ...
        isAutoDispose: true,
        dependencies: <ProviderOrFamily>[dep2Provider],
        $allTransitiveDependencies: <ProviderOrFamily>[
          ExtraDepProvider.$allTransitiveDependencies0,
        ],
      );

  static final $allTransitiveDependencies0 = dep2Provider;
...
String _$extraDepHash() => r'f265b881501f52f846cfada40c26e7a99fff5775';
