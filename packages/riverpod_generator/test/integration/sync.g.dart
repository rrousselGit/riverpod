...
final class ComplexGenericProvider<T extends num, Foo extends String?>
  ...
  const ComplexGenericProvider._(
      ...
      : _createCb = create,
        super(
          debugGetCreateSourceHash: _$complexGenericHash,
          name: r'complexGeneric',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
  ...
  const RawFutureProvider._(
      ...
      : _createCb = create,
        super(
          from: null,
          argument: null,
          debugGetCreateSourceHash: _$rawFutureHash,
          name: r'rawFuture',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
...
final class RawFamilyFutureProvider extends $FunctionalProvider<
  ...
  const RawFamilyFutureProvider._(
      ...
      : _createCb = create,
        super(
          debugGetCreateSourceHash: _$rawFamilyFutureHash,
          name: r'rawFamilyFuture',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
...
final class RawFamilyStreamProvider extends $FunctionalProvider<
  ...
  const RawFamilyStreamProvider._(
      ...
      : _createCb = create,
        super(
          debugGetCreateSourceHash: _$rawFamilyStreamHash,
          name: r'rawFamilyStream',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
  ...
  const Supports$inNamesProvider._(
      ...
      : _createCb = create,
        super(
          from: null,
          argument: null,
          debugGetCreateSourceHash: _$supports$inNamesHash,
          name: r'supports$inNames',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
  ...
  const RawFutureClassProvider._(
      ...
      : _createCb = create,
        super(
          from: null,
          argument: null,
          debugGetCreateSourceHash: _$rawFutureClassHash,
          name: r'RawFutureClass',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
  ...
  const RawStreamClassProvider._(
      ...
      : _createCb = create,
        super(
          from: null,
          argument: null,
          debugGetCreateSourceHash: _$rawStreamClassHash,
          name: r'RawStreamClass',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
...
final class RawFamilyFutureClassProvider
  ...
  const RawFamilyFutureClassProvider._(
      ...
      : _createCb = create,
        super(
          debugGetCreateSourceHash: _$rawFamilyFutureClassHash,
          name: r'RawFamilyFutureClass',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
...
final class RawFamilyStreamClassProvider
  ...
  const RawFamilyStreamClassProvider._(
      ...
      : _createCb = create,
        super(
          debugGetCreateSourceHash: _$rawFamilyStreamClassHash,
          name: r'RawFamilyStreamClass',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
  ...
  const Supports$InClassNameProvider._(
      ...
      : _createCb = create,
        super(
          from: null,
          argument: null,
          debugGetCreateSourceHash: _$supports$InClassNameHash,
          name: r'Supports$InClassName',
          isAutoDispose: true,
          dependencies: null,
          allTransitiveDependencies: null,
        );
