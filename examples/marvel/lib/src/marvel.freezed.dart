...
mixin _$MarvelListCharactersResponse {
 ...
 int get totalCount; List<Character> get characters;
/// Create a copy of MarvelListCharactersResponse
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MarvelListCharactersResponseCopyWith<MarvelListCharactersResponse> get copyWith => _$MarvelListCharactersResponseCopyWithImpl<MarvelListCharactersResponse>(this as MarvelListCharactersResponse, _$identity);



@override
bool operator ==(Object other) {
  final _this = this as MarvelListCharactersResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarvelListCharactersResponse&&(identical(other.totalCount, _this.totalCount) || other.totalCount == _this.totalCount)&&const DeepCollectionEquality().equals(other.characters, _this.characters));
}
...
int get hashCode {
  final _this = this as MarvelListCharactersResponse;
  return Object.hash(runtimeType,_this.totalCount,const DeepCollectionEquality().hash(_this.characters));
}

@override
String toString() {
  final _this = this as MarvelListCharactersResponse;
  return 'MarvelListCharactersResponse(totalCount: ${_this.totalCount}, characters: ${_this.characters})';
}
...
abstract mixin class $MarvelListCharactersResponseCopyWith<$Res>  {
  factory $MarvelListCharactersResponseCopyWith(MarvelListCharactersResponse value, $Res Function(MarvelListCharactersResponse) _then) = _$MarvelListCharactersResponseCopyWithImpl;
@useResult
$Res call({
 int totalCount, List<Character> characters
});
...
/// Adds pattern-matching-related methods to [MarvelListCharactersResponse].
extension MarvelListCharactersResponsePatterns on MarvelListCharactersResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarvelListCharactersResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MarvelListCharactersResponse() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MarvelListCharactersResponse value)  $default,){
final _that = this;
switch (_that) {
case _MarvelListCharactersResponse():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MarvelListCharactersResponse value)?  $default,){
final _that = this;
switch (_that) {
case _MarvelListCharactersResponse() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalCount,  List<Character> characters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MarvelListCharactersResponse() when $default != null:
return $default(_that.totalCount,_that.characters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalCount,  List<Character> characters)  $default,) {final _that = this;
switch (_that) {
case _MarvelListCharactersResponse():
return $default(_that.totalCount,_that.characters);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalCount,  List<Character> characters)?  $default,) {final _that = this;
switch (_that) {
case _MarvelListCharactersResponse() when $default != null:
return $default(_that.totalCount,_that.characters);case _:
  return null;
...
@pragma('vm:prefer-inline')
_$MarvelListCharactersResponseCopyWith<_MarvelListCharactersResponse> get copyWith => __$MarvelListCharactersResponseCopyWithImpl<_MarvelListCharactersResponse>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _MarvelListCharactersResponse&&(identical(other.totalCount, totalCount) || other.totalCount == totalCount)&&const DeepCollectionEquality().equals(other.characters, _characters));
}


@override
int get hashCode {
    return Object.hash(runtimeType,totalCount,const DeepCollectionEquality().hash(_characters));
}
...
/// @nodoc
abstract mixin class _$MarvelListCharactersResponseCopyWith<$Res> implements $MarvelListCharactersResponseCopyWith<$Res> {
  factory _$MarvelListCharactersResponseCopyWith(_MarvelListCharactersResponse value, $Res Function(_MarvelListCharactersResponse) _then) = __$MarvelListCharactersResponseCopyWithImpl;
@override @useResult
$Res call({
 int totalCount, List<Character> characters
});
...
/// Create a copy of MarvelListCharactersResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalCount = null,Object? characters = null,}) {
...
mixin _$Character {
 ...
 int get id; String get name; Thumbnail get thumbnail;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Character&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.thumbnail, _this.thumbnail) || other.thumbnail == _this.thumbnail));
}
...
int get hashCode {
  final _this = this as Character;
  return Object.hash(runtimeType,_this.id,_this.name,_this.thumbnail);
}

@override
String toString() {
  final _this = this as Character;
  return 'Character(id: ${_this.id}, name: ${_this.name}, thumbnail: ${_this.thumbnail})';
}
...
@useResult
$Res call({
 int id, String name, Thumbnail thumbnail
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  Thumbnail thumbnail)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Character() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  Thumbnail thumbnail)  $default,) {final _that = this;
switch (_that) {
case _Character():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  Thumbnail thumbnail)?  $default,) {final _that = this;
switch (_that) {
case _Character() when $default != null:
return $default(_that.id,_that.name,_that.thumbnail);case _:
  return null;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Character&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,thumbnail);
}
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Thumbnail&&(identical(other.url, _this.url) || other.url == _this.url)&&(identical(other.path, _this.path) || other.path == _this.path)&&(identical(other.extension, _this.extension) || other.extension == _this.extension));
}
...
int get hashCode {
  final _this = this as Thumbnail;
  return Object.hash(runtimeType,_this.url,_this.path,_this.extension);
}

@override
String toString() {
  final _this = this as Thumbnail;
  return 'Thumbnail(url: ${_this.url}, path: ${_this.path}, extension: ${_this.extension})';
}
...
switch (_that) {
case _Thumbnail():
return $default(_that.path,_that.extension);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@override
int get hashCode {
    return Object.hash(runtimeType,path,extension);
}
...
@override
bool operator ==(Object other) {
  final _this = this as MarvelResponse;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarvelResponse&&(identical(other.data, _this.data) || other.data == _this.data));
}
...
String toString() {
  final _this = this as MarvelResponse;
  return 'MarvelResponse(data: ${_this.data})';
}
...
mixin _$MarvelData {
 ...
 List<Map<String, Object?>> get results; int get total;
...
@override
bool operator ==(Object other) {
  final _this = this as MarvelData;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarvelData&&const DeepCollectionEquality().equals(other.results, _this.results)&&(identical(other.total, _this.total) || other.total == _this.total));
}
...
int get hashCode {
  final _this = this as MarvelData;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.results),_this.total);
}

@override
String toString() {
  final _this = this as MarvelData;
  return 'MarvelData(results: ${_this.results}, total: ${_this.total})';
}
...
@useResult
$Res call({
 List<Map<String, Object?>> results, int total
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Map<String, Object?>> results,  int total)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MarvelData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Map<String, Object?>> results,  int total)  $default,) {final _that = this;
switch (_that) {
case _MarvelData():
return $default(_that.results,_that.total);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Map<String, Object?>> results,  int total)?  $default,) {final _that = this;
switch (_that) {
case _MarvelData() when $default != null:
return $default(_that.results,_that.total);case _:
  return null;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _MarvelData&&const DeepCollectionEquality().equals(other.results, _results)&&(identical(other.total, total) || other.total == total));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_results),total);
}
