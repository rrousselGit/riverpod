...
import creatingProvider from "/docs/concepts2/providers/creating_a_provider";
...
[notifierProvider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.16/hooks_riverpod/Notifier-class.html
