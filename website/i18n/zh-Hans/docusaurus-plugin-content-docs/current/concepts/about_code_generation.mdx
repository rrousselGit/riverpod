...
- 更好的语法，更具可读性/灵活性，并且学习曲线更短。
  - 无需担心提供商的类型。写下您的逻辑，Riverpod 将为您选择最合适的提供商。
...
-->
使用代码生成时，我们不再需要依赖 `family` 修饰符将参数传递给提供者。
相反，我们的提供程序的主函数可以接受任意数量的参数，包括命名、可选或默认值。  
