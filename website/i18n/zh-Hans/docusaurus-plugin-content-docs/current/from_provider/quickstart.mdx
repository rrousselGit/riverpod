...
[ChangeNotifierProvider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.18/legacy/ChangeNotifierProvider-class.html
[Code generation]: /docs/concepts/about_code_generation
[Riverpod's providers]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.18/hooks_riverpod/Notifier-class.html
...
[Riverpod 的提供者程序]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.18/hooks_riverpod/Notifier-class.html
