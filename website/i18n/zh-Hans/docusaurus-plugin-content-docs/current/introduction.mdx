...
不信？这里有一个例子。下面的代码片段是使用 Riverpod 的一个简化的 [Pub.dev](https://github.com/rrousselGit/riverpod/tree/master/examples/pub) 客户端应用。
...
这段代码就是你要实现“在键入时搜索”“下拉刷新”和“无限列表”功能所需的全部业务逻辑，同时还可以处理错误及加载中的状态。
