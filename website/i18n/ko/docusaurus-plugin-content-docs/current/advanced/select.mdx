...
<AutoSnippet
  {...select} 
  translations={{
    raw_watch: "    // 아래처럼 작성하는 대신:\n    // String name = ref.watch(provider).firstName!;\n    // 이렇게 작성할 수 있습니다:",
    raw_note: "    // 그러면 위젯이 'firstName'에 대한 변경 사항만 수신하게 됩니다.",
    codegen_watch: "    // 아래처럼 작성하는 대신:\n    // String name = ref.watch(provider).firstName!;\n    // 이렇게 작성할 수 있습니다:",
    codegen_note: "    // 그러면 위젯이 'firstName'에 대한 변경 사항만 수신하게 됩니다.",
  }}
/>
...
문제는 `select`이 `AsyncValue`에 적용된다는 것인데, 이는 기다릴 수 있는(await) 상황이 아닙니다.
...
<AutoSnippet
  {...selectAsync}
  translations={{
    raw_watch: "  // user를 사용할 수 있을 때까지 기다렸다가 \"firstName\" 속성만 수신합니다.",
    raw_todo: "  // TODO 다른 항목을 가져오기위해 \"firstName\"을 사용합니다.",
    codegen_watch: "  // user를 사용할 수 있을 때까지 기다렸다가 \"firstName\" 속성만 수신합니다.",
    codegen_todo: "  // TODO 다른 항목을 가져오기위해 \"firstName\"을 사용합니다.",
  }}
/>
