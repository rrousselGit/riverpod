...
<AutoSnippet 
  {...functionalRef} 
  translations={{
    raw_provider: "  // \"Ref\"를 사용하여 다른 공급자를 읽을 수 있습니다.",
    codegen_provider: "  // \"Ref\"를 사용하여 다른 공급자를 읽을 수 있습니다.",
  }}
/>
...
<AutoSnippet 
  {...notifierRef} 
  translations={{
    raw_watch: "    // \"Ref\"를 사용하여 다른 공급자를 읽을 수 있습니다.",
    codegen_watch: "    // \"Ref\"를 사용하여 다른 공급자를 읽을 수 있습니다.",
  }}
/>
...
<AutoSnippet 
  {...watchExample} 
  translations={{
    raw_provider: "  // TO-DO: 현재 위치를 가져오는 스트림을 반환합니다.",
    raw_watch: "  // \"ref.watch\"를 사용하여 최신 위치를 가져옵니다.\n  // 공급자 뒤에 \".future\"를 지정하면 코드가 적어도 하나의 위치를 사용할 수 있을 때까지 기다립니다.",
    raw_get: "  // 이제 해당 위치를 기반으로 네트워크 요청을 할 수 있습니다.\n  // 예를 들어 Google 지도 API를 사용할 수 있습니다:",
    raw_jsonDecode: "  // JSON에서 레스토랑 이름 가져오기",
    codegen_provider: "  // TO-DO: 현재 위치를 가져오는 스트림을 반환합니다.",
    codegen_watch: "  // \"ref.watch\"를 사용하여 최신 위치를 가져옵니다.\n  // 공급자 뒤에 \".future\"를 지정하면 코드가 적어도 하나의 위치를 사용할 수 있을 때까지 기다립니다.",
    codegen_get: "  // 이제 해당 위치를 기반으로 네트워크 요청을 할 수 있습니다.\n  // 예를 들어 Google 지도 API를 사용할 수 있습니다:",
    codegen_jsonDecode: "  // JSON에서 레스토랑 이름 가져오기",
  }}
/>
...
<AutoSnippet 
  {...readExample} 
  translations={{
    raw_read: "    // Bad! 반응형이 아니므로 여기서는 'read'를 사용하지 마십시오.",
    raw_read2: "    ref.read(otherProvider); // 여기서 '읽기'를 사용해도 괜찮습니다.",
  }}
/>
