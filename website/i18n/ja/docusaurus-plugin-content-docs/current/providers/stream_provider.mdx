...
import streamProvider from "!!raw-loader!/i18n/ja/docusaurus-plugin-content-docs/current/providers/stream_provider/live_stream_chat_provider.dart";
import streamConsumer from "!!raw-loader!/i18n/ja/docusaurus-plugin-content-docs/current/providers/stream_provider/live_stream_chat_consumer.dart";
