...
import listen from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/concepts/reading_listen.dart";
import listenBuild from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/concepts/reading_listen_build.dart";
