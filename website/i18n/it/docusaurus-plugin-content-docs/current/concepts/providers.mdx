...
- Integrazione facile di feature avanzate, come logging e trascina per aggiornare
...
Uno scenario comune in queste situazioni è quello di fare un clean-up (pulizia) prima che lo stato di un provider
sia distrutto, come la chiusura di uno `StreamController`.
