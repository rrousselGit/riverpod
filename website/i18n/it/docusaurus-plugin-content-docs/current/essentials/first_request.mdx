...
- `autoDispose`, il quale pulirà automaticamente la cache quando il provider smetterà di essere usato.  
...
Vedere <Link documentID="introduction/getting_started" hash="enabling-riverpod_lintcustom_lint" /> per i passaggi di installazione.
:::
