...
import configProvider from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/future_provider/config_provider.dart";
import configConsumer from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/future_provider/config_consumer.dart";
