...
import product from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/state_provider/product.dart";
import productListView from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/state_provider/product_list_view.dart";
...
import sortedProductProvider from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/state_provider/sorted_product_provider.dart";
...
import updateReadOnce from "!!raw-loader!/i18n/it/docusaurus-plugin-content-docs/current/providers/state_provider/update_read_once.dart";
...
```dart
// Un enum che rappresenta il tipo di filtro.
