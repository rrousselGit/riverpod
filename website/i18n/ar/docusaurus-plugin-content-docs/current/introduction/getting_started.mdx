...
إذا كنت تستخدم `Flutter` و`VS Code`، ففكر في استخدام [إضافة Flutter Riverpod](https://marketplace.visualstudio.com/items?itemName=robert-brunhage.flutter-riverpod-snippets)

إذا كنت تستخدم `Flutter` و`Android Studio` أو `IntelliJ`، ففكر في استخدام [إضافة Flutter Riverpod](https://plugins.jetbrains.com/plugin/14641-flutter-riverpod-snippets)
