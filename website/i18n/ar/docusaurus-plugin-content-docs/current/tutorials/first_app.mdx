...
لكي تستطيع حزمة  Riverpod العمل بشكل صحيح,نحتاج لتحديث وظيفة `main` لكي تتظمن  [ProviderScope].  
...
يمكننا وضع هذه السطور البرمجية في داخل ملف  `joke.dart` الذي أنشأناه سابقًا،,
بما ان هذه السطور البرمجية مرتبطة إرتباطا وثيقا بكائن `Joke`.
