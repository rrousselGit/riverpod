...
But this inconvenience is fairly minor in the grand scheme of things. And it
is not impossible that this requirement will one day disappear.
...
"watch" to descibe "this widget should rebuild when the value changes".
...
<!-- TODO explain how to convert ProxyProvider to ref.watch/ref.listen -->
