...
- It solves an issue where `onPressed` callbacks combined with [Ref.read] and [autoDispose](./essentials/auto_dispose)
...
onPressed: () {
  addTodoMutation.run(ref, (ref) async {
    ...
    await ref.get(todoListProvider.notifier).addTodo('New Todo');
  });
}
```

:::note
Note how we called [ref.get] here instead of [Ref.read].  
This is a feature unique to mutations. That [ref.get] obtains the state of a provider,
...
[Mutation]: https://pub.dev/documentation/riverpod/3.0.0-dev.16/experimental_mutation/Mutation-class.html
...
[ref.get]: https://pub.dev/documentation/riverpod/3.0.0-dev.16/experimental_mutation/MutationTransaction/get.html
...
[SyncProviderTransformerMixin]: https://pub.dev/documentation/riverpod/3.0.0-dev.16/misc/SyncProviderTransformerMixin-mixin.html
[ProviderListenable]: https://pub.dev/documentation/riverpod/3.0.0-dev.16/misc/ProviderListenable-class.html