...
[paradigm shift](/docs/concepts/why_immutability), but it brings great simplification with the resulting migrated
code.
...
:::tip
Remember: use [snippets in your IDE](/docs/introduction/getting_started#going-further-installing-code-snippets)
to get some guidance, or just to speed up your code writing.
:::
...
state afterwards. Read more about performing side effects in its [dedicated page](/docs/essentials/side_effects).
:::
