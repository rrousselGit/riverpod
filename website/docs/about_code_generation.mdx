...
- <span style={BLUE_STYLE}>Function-based</span> provider and
  <span style={BLUE_STYLE}> Class-based</span> provider are pretty much the same,
  but Class-based provider has the advantage of including public methods that enable
  external objects to modify the state of the provider (side-effects). Providers,
  by default, do not have a way to be modified from outside.
...
<table>
  ...
  <tr>
    <td>
      <span style={FONT_16_STYLE}>
        <span style={RED_STYLE}>Sync</span> initialization
      </span>
    </td>
  ...
  <tr>
    <td>
      <span style={FONT_16_STYLE}>
        <span style={RED_STYLE}>Async</span> initialization - Returns a Future
      </span>
    </td>
    <td style={MAX_WIDTH_420}>
  ...
  <tr>
    <td>
      <span style={FONT_16_STYLE}>
        <span style={RED_STYLE}>Async</span> initialization - Returns a Stream
      </span>
    </td>
    <td style={MAX_WIDTH_420}>
