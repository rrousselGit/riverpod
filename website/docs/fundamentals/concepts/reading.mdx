...
:::caution
The `watch` method passed as argument of [Consumer] should not be called be called
...
- My object reads a lot of providers, is there a way to simplify the syntax?
