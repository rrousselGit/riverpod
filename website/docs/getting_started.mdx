...
import { AutoSnippet, ConditionalSnippet } from "../src/components/CodeSnippet";
...
<ConditionalSnippet codegen={true}>
  You can now run the code-generator with <code>dart run build_runner watch</code>.
</ConditionalSnippet>
...
<ConditionalSnippet codegen={true}>
  You can now run the code-generator with <code>flutter pub run build_runner watch</code>.
</ConditionalSnippet>
