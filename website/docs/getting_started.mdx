...
class MyApp extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // To read our provider, we can use
...
If you are using `Vscode` , consider using [Flutter Riverpod Snippets](https://marketplace.visualstudio.com/items?itemName=robert-brunhage.flutter-riverpod-snippets)

If you are using `Android Studio` or `IntelliJ`, consider using [Flutter Riverpod Snippets](https://plugins.jetbrains.com/plugin/14641-flutter-riverpod-snippets)
