...
For immutable collections: (i.e. Map, Set, List)
...
It is highly recommended to use `freezed`, since it has several nice additions beyond just making an immutable object.
Such as:
