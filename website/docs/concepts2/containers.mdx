...
Use [ProviderContainer.test](https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.16/hooks_riverpod/ProviderContainer/ProviderContainer.test.html) instead.
...
[ProviderObserver]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.16/hooks_riverpod/ProviderObserver-class.html