...
This happens by tracking [Ref.watch](https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Ref/watch.html)/[Ref.listen](https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Ref/listen.html)
calls (and a few others).  

When that counter reaches zero, the provider will be considered as "not used", and
[Ref.onCancel](https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Ref/onCancel.html)
will be triggered. 
...
[Ref.onDispose](https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Ref/onDispose.html)
will be triggered.
