...
[JsonPersist]: https://pub.dev/documentation/riverpod_annotation/3.0.0-dev.17/experimental_json_persist/JsonPersist-class.html
[Storage.inMemory]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.17/experimental_persist/Storage/Storage.inMemory.html