...
which will cache the result of said function ; and allow multiple widgets
...
- Built-in mocking support, for better testing.
- Offline persistence.  
...
But hte principle is similar: "One object, immutable" vs "Two objects, mutable".
:::
...
- `autoDispose`, which will automatically clear the cache when the provider
  stops being used.  
  See also <Link documentID="concept2/auto_dispose" />
...
:::note
Notifiers should not have properties besides the built-in `state`, as any state
outside of `state` may be inadvertently destroyed by Riverpod.
:::
...
- <span style={{ color: colors[0] }}>AsyncNotifier</span>Provider.<span
...
[provider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Provider-class.html
[futureprovider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/FutureProvider-class.html
[streamprovider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/StreamProvider-class.html
[notifierprovider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/NotifierProvider-class.html
[asyncnotifierprovider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/AsyncNotifierProvider-class.html
[streamnotifierprovider]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/StreamNotifierProvider-class.html
[ref]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/Ref-class.html
[widgetref]: https://pub.dev/documentation/hooks_riverpod/3.0.0-dev.15/hooks_riverpod/WidgetRef-class.html
