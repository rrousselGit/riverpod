...
[paradigm shift]: /docs/from_provider/quickstart#migrate-one-provider-at-a-time
[this migration guide]: /docs/migration/1.0.0_to_2.0.0#from-statenotifieror-changenotifier-to-notifier-or-asyncnotifier
