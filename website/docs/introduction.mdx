...
These features can be tricky to implement, but are crutial for a good user experience.  
...
What if I told you that this snippet is all the business logic you need for a
"seach as we type" + "pull to refresh" + "infinite list",
while handling error/loading states?
