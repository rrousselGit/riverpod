...
If you are using `Flutter` and `Android Studio` or `IntelliJ`, consider using [Riverpod Gen Shortcuts](https://plugins.jetbrains.com/plugin/30670-riverpod-gen-shortcuts) OR [Flutter Riverpod Snippets](https://plugins.jetbrains.com/plugin/14641-flutter-riverpod-snippets)

**Example: Using Generator - Riverpod Stream (`riverpodStream`) **
![riverpod-class](/img/snippets/riverpod-stream.gif)

**Example: Using Generator - Riverpod Class (`riverpodClassKeepAlive`)**
